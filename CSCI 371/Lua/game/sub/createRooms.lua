...
for line in io.lines("data") do
	...
	if (north == "0") then
		...
		io.write("\tif (move == 1) then return "..north.."; end\n");
	end
	...
	if (east == "0") then
		...
		io.write("\tif (move == 2) then return "..east.."; end\n");
	end
	...
	if (south == "0") then
		...
		io.write("\tif (move == 3) then return "..south.."; end\n");
	end
	...
	if (west == "0") then
		...
		io.write("\tif (move == 4) then return "..west.."; end\n");
	end
